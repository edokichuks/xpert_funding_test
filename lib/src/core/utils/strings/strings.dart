...
class Strings {
  static String serverError = Intl.message(
    'A server error occurred',
    locale: 'en',
  );
  static String genericErrorMessage = Intl.message(
    'An error occurred',
    locale: 'en',
  );
  static String titleErrorMessage = Intl.message('Failed', locale: 'en');
  static String connectionError = Intl.message(
    'Please check your internet connection',
    locale: 'en',
  );
  static String timeout = Intl.message(
    'Your connection timed out',
    locale: 'en',
  );
  static String personalInfo = Intl.message(
    'Personal information',
    locale: 'en',
  );
  static String enterLogin = Intl.message(
    'Enter login details provided to get started',
    locale: 'en',
  );
  ...
  static String dontHaveAcc = Intl.message(
    'Already have an account? ',
    locale: 'en',
  );
  static String alreadyHaveAcc = Intl.message(
  ...
  static String newPasswordsub = Intl.message(
    'Create new password',
    locale: 'en',
  );
  static String userProfile = Intl.message('User Profile', locale: 'en');
  static String editUserProfile = Intl.message(
  ...
  static String sidesId = Intl.message(
    '6545022394b3aceac5be3e84',
    locale: 'en',
  );
}
